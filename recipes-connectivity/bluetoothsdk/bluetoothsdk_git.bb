...
DEPENDS = "cmake-native breakpad rdk-logger breakpad-wrapper bluez5 glib-2.0 sdbus-c++ pipewire wireplumber"
RDEPENDS:${PN} = "rdk-logger bluez5 sdbus-c++ pipewire wireplumber"
SRC_URI = "git://github.com/rdkcentral/bluetooth-sdk.git;protocol=https;branch=RDK-61473"
SRCREV = "b32b3bd42e8706001d50d4e6ec8187b47fe72cf5"
S = "${WORKDIR}/git"
