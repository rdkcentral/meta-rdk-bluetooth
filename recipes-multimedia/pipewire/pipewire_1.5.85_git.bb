...
PACKAGECONFIG:remove:aarch64 = "gstreamer vulkan"
...
FILES:${PN} = " \
    ...
    ${bindir}/pipewire \
    ${bindir}/pipewire-avb \
    ${includedir}/pipewire/*.h \
    ${includedir}/pipewire/stream.h \
    ${includedir}/spa/param/audio/format-utils.h \
    ${includedir}/spa/utils/*.h \
    ${includedir}/spa/pod/*.h \
    ${includedir}/spa/debug/types.h \
    ${includedir}/spa/monitor/type-info.h \
    ${includedir}/spa/monitor/event.h \
    ${includedir}/spa/node/*.h \
    ${includedir}/spa/param/*.h \
    ${includedir}/spa/param/audio/*.h \
    ${includedir}/spa/param/bluetooth/*.h \
    ${includedir}/spa/param/video/*.h \
    ${includedir}/spa/param/control/*.h \
    ${includedir}/spa/support/*.h \
    ${includedir}/pipewire-0.3/pipewire/version.h \
    ${libdir}/spa-0.2/libspa.so \
    ${bindir}/pw-container \
...
do_install:append() {
    ...
    install -d ${D}${includedir}/spa/param/bluetooth
    install -d ${D}${includedir}/spa/param/video
    install -d ${D}${includedir}/spa/utils
    install -d ${D}${includedir}/spa/pod
    install -d ${D}${includedir}/spa/debug
    install -d ${D}${includedir}/spa/monitor
    install -d ${D}${includedir}/spa/node
    install -d ${D}${includedir}/spa/buffer
    install -d ${D}${includedir}/spa/control
    install -d ${D}${includedir}/spa/support
    install -m 0755 ${S}/src/pipewire/*.h ${D}${includedir}/pipewire/
    install -m 0755 ${D}${includedir}/pipewire-0.3/pipewire/version.h ${D}${includedir}/pipewire/
    install -m 0755 ${S}/src/pipewire/stream.h ${D}${includedir}/pipewire/
    install -m 0755 ${S}/spa/include/spa/utils/* ${D}${includedir}/spa/utils/
    install -m 0755 ${S}/spa/include/spa/debug/* ${D}${includedir}/spa/debug/
    install -m 0755 ${S}/spa/include/spa/pod/*.h ${D}${includedir}/spa/pod/
    install -m 0755 ${S}/spa/include/spa/monitor/type-info.h ${D}${includedir}/spa/monitor/
    install -m 0755 ${S}/spa/include/spa/monitor/event.h ${D}${includedir}/spa/monitor/
    install -m 0755 ${S}/spa/include/spa/node/*.h ${D}${includedir}/spa/node/
    install -m 0755 ${S}/spa/include/spa/param/*.h ${D}${includedir}/spa/param/
    install -m 0755 ${S}/spa/include/spa/param/audio/*.h ${D}${includedir}/spa/param/audio/
    install -m 0755 ${S}/spa/include/spa/param/bluetooth/*.h ${D}${includedir}/spa/param/bluetooth/
    install -m 0755 ${S}/spa/include/spa/param/video/*.h ${D}${includedir}/spa/param/video/
    install -m 0755 ${S}/spa/include/spa/buffer/*.h ${D}${includedir}/spa/buffer/
    install -m 0755 ${S}/spa/include/spa/control/*.h ${D}${includedir}/spa/control/
    install -m 0755 ${S}/spa/include/spa/support/*.h ${D}${includedir}/spa/support/
}

inherit syslog-ng-config-gen
SYSLOG-NG_FILTER_client += "pipewire"
SYSLOG-NG_SERVICE_pipewire_client += "pipewire.service"
