...
SRC_URI = "git://gitlab.freedesktop.org/pipewire/wireplumber.git;branch=master;protocol=https \
           ...
           file://wireplumber_sandbox_allow_os_execute.patch \
           "
...
FILES:${PN} += "${systemd_user_unitdir} ${systemd_system_unitdir} ${datadir}/zsh ${datadir}/bash-completion"
...
SYSLOG-NG_FILTER_client += "wireplumber"
